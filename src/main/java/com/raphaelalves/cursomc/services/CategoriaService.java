...
import com.raphaelalves.cursomc.services.exceptions.DataIntegrityException;
...
public class CategoriaService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Nao é possível excluir um categoria com produtos");
		}
	}
